...
"}")
        ...
        icon3 = QIcon()
        icon3.addFile(u":/icons/keyboard.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.MainWindowTools_tabs.addTab(self.hotkeyeditor_tab, icon3, "")
        ...
        self.MainWindowTools_tabs.addTab(self.smartpropeditor_tab, icon5, "")
        ...
        self.dockWidget.setMinimumSize(QSize(88, 107))
...
"")
        ...
        self.MainWindowTools_tabs.setCurrentIndex(5)
