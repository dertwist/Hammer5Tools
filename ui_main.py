...
"}")
        ...
        self.bluesky_button = QPushButton(self.centralwidget)
        self.bluesky_button.setObjectName(u"bluesky_button")
        self.bluesky_button.setMinimumSize(QSize(32, 0))
        self.bluesky_button.setMaximumSize(QSize(32, 16777210))
        self.bluesky_button.setStyleSheet(u"padding: 5px;")
        icon7 = QIcon()
        icon7.addFile(u":/social/icons/social/bluesky.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.bluesky_button.setIcon(icon7)
        self.bluesky_button.setIconSize(QSize(20, 20))

        self.horizontalLayout.addWidget(self.bluesky_button)
        ...
        icon8 = QIcon()
        icon8.addFile(u":/social/icons/social/discord.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        self.ComboBoxSelectAddon.setStyleSheet(u"QComboBox {\n"
"    font: 700 pt 10px \"Segoe UI\";\n"
...
"")
        ...
        self.open_addons_folder_downlist.setStyleSheet(u"QComboBox {\n"
"    font: 700 pt 10px \"Segoe UI\";\n"
"    border: 2px solid black;\n"
"    border-radius: 4px;\n"
"    border-color: rgba(80, 80, 80, 255);\n"
...
#if QT_CONFIG(tooltip)
        self.bluesky_button.setToolTip(QCoreApplication.translate("MainWindow", u"<html><head/><body><p>Bluesky</p></body></html>", None))
#endif // QT_CONFIG(tooltip)
        self.bluesky_button.setText("")
#if QT_CONFIG(tooltip)
