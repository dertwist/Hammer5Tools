...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.setStyleSheet(u"background-color: rgb(28, 28, 28);")
...
"    }")
        ...
        self.save_button.setMinimumSize(QSize(196, 0))
...
"    }")
        ...
        self.save_restart_button.setMinimumSize(QSize(196, 0))
...
#endif // QT_CONFIG(shortcut)
#if QT_CONFIG(tooltip)
        self.open_button.setToolTip(QCoreApplication.translate("MainWindow", u"<html><head/><body><p>Ctrl + N</p></body></html>", None))
#endif // QT_CONFIG(tooltip)
        self.open_button.setText(QCoreApplication.translate("MainWindow", u"Open preset", None))
#if QT_CONFIG(shortcut)
        self.open_button.setShortcut(QCoreApplication.translate("MainWindow", u"Ctrl+N", None))
#endif // QT_CONFIG(shortcut)
...
#endif // QT_CONFIG(tooltip)
        self.save_restart_button.setText(QCoreApplication.translate("MainWindow", u"Set and restart", None))
#if QT_CONFIG(shortcut)
