...
################################################################################
## Form generated from reading UI file 'material_replacements.ui'
##
...
"color: rgb(247, 208, 255);")
        ...
        self.layout_replacements = QVBoxLayout()
        self.layout_replacements.setObjectName(u"layout_replacements")

        self.verticalLayout_3.addLayout(self.layout_replacements)

        self.add_replacement_widget = QPushButton(self.frame_3)
        self.add_replacement_widget.setObjectName(u"add_replacement_widget")
        self.add_replacement_widget.setStyleSheet(u"\n"
"    QPushButton {\n"
...
"    }")
    ...
    def retranslateUi(self, Widget):
        ...
        self.property_class.setText(QCoreApplication.translate("Widget", u"Material Replacements", None))
        self.add_replacement_widget.setText(QCoreApplication.translate("Widget", u"Add Replacement", None))
    # retranslateUi
