...
"")
        ...
        self.value = QPushButton(self.frame)
        self.value.setObjectName(u"value")
        self.value.setMinimumSize(QSize(128, 0))
        self.value.setStyleSheet(u"background-color: rgb(238, 0, 255);\n"
"padding:4px;\n"
"border:0px;\n"
...
"border-color: rgba(80, 80, 80, 100);")
    ...
    def retranslateUi(self, Widget):
        ...
        self.logic_switch.setItemText(1, QCoreApplication.translate("Widget", u"RGB", None))
