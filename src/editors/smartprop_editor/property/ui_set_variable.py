...
################################################################################
## Form generated from reading UI file 'set_variable.ui'
##
...
"}")
        ...
        self.property_class_4 = QLabel(self.frame_2)
        self.property_class_4.setObjectName(u"property_class_4")
        sizePolicy.setHeightForWidth(self.property_class_4.sizePolicy().hasHeightForWidth())
        self.property_class_4.setSizePolicy(sizePolicy)
        self.property_class_4.setStyleSheet(u"border:0px;\n"
"background-color: rgba(255, 255, 255, 0);\n"
"font: 8pt \"Segoe UI\";\n"
"padding-right: 16px;\n"
"")

        self.layout_2.addWidget(self.property_class_4)
...
"}")
        ...
        self.layout_3.setSizeConstraint(QLayout.SizeConstraint.SetFixedSize)
        self.logic_switch_value = QComboBox(self.frame_3)
        self.logic_switch_value.addItem("")
        self.logic_switch_value.addItem("")
        self.logic_switch_value.setObjectName(u"logic_switch_value")
        sizePolicy1.setHeightForWidth(self.logic_switch_value.sizePolicy().hasHeightForWidth())
        self.logic_switch_value.setSizePolicy(sizePolicy1)
        self.logic_switch_value.setMaximumSize(QSize(16777215, 24))
        self.logic_switch_value.setStyleSheet(u"QComboBox {\n"
"    font: 580 8pt \"Segoe UI\";\n"
"    border: 2px solid black;\n"
"    border-radius: 0px;\n"
"    border-color: rgba(80, 80, 80, 255);\n"
...
"")
        ...
        self.layout_3.addWidget(self.logic_switch_value)


        self.horizontalLayout_4.addLayout(self.layout_3)
        ...
        self.logic_switch_value.setCurrentIndex(0)
    ...
    def retranslateUi(self, Widget):
        ...
        self.property_class.setText(QCoreApplication.translate("Widget", u"Type", None))
        self.logic_switch.setItemText(0, QCoreApplication.translate("Widget", u"Bool", None))
        self.logic_switch.setItemText(1, QCoreApplication.translate("Widget", u"Float", None))
        self.logic_switch.setItemText(2, QCoreApplication.translate("Widget", u"Int", None))

        self.property_class_4.setText(QCoreApplication.translate("Widget", u"Variable", None))
        self.logic_switch_value.setItemText(0, QCoreApplication.translate("Widget", u"Value", None))
        self.logic_switch_value.setItemText(1, QCoreApplication.translate("Widget", u"Expression", None))
