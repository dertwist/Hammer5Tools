...
operators_list = [
    ...
    {'RandomColorTintColor': {'_WARN_NOT_VERIFIED': True, '_class': "CSmartPropOperation_RandomColorTintColor", "m_SelectionMode": "RANDOM", "m_Color": [255, 255, 255], "m_ColorPosition": 0.0, "m_Mode": "MULTIPLY_OBJECT"}},
    {'CreateSizer': {
    ...
    {'RotateTowards': {'_WARN_NOT_VERIFIED': True, '_class': 'CSmartPropOperation_RotateTowards', 'm_vOriginPos': None, 'm_vTargetPos': None, 'm_vUpPos': None, 'm_flWeight': 1.0, 'm_OriginSpace': 'WORLD', 'm_TargetSpace': 'WORLD', 'm_UpSpace': 'WORLD'}},
    {'SaveColor': {'_WARN_NOT_VERIFIED': True, '_class': 'CSmartPropOperation_SaveColor', 'm_VariableName': ''}},
    {'SaveDirection': {'_WARN_NOT_VERIFIED': True, '_class': 'CSmartPropOperation_SaveDirection', 'm_DirectionVector': 'FORWARD', 'm_CoordinateSpace': 'WORLD', 'm_VariableName': ''}},
    {'SavePosition': {'_WARN_NOT_VERIFIED': True, '_class': 'CSmartPropOperation_SavePosition', 'm_CoordinateSpace': 'WORLD', 'm_VariableName': ''}},
    {'SaveScale': {'_class': 'CSmartPropOperation_SaveScale', 'm_VariableName': ''}},
    {'SaveSurfaceNormal': {'_WARN_NOT_VERIFIED': True, '_class': 'CSmartPropOperation_SaveSurfaceNormal', 'm_CoordinateSpace': 'WORLD', 'm_VariableName': ''}},
    {'SetMaterialGroupChoice': {'_WARN_NOT_VERIFIED': True, '_class': 'CSmartPropOperation_SetMaterialGroupChoice', 'm_VariableName': '', 'm_SelectionMode': 'RANDOM', 'm_ChoiceSelection': 0, 'm_MaterialGroupChoices': []}},
    ...
    {'Trace': {'_WARN_NOT_VERIFIED': True, '_class': 'CSmartPropOperation_Trace', 'm_Origin': None, 'm_OriginSpace': 'WORLD', 'm_flOriginOffset': 0.0, 'm_flSurfaceUpInfluence': 1.0, 'm_nNoHitResult': 'NOTHING', 'm_bIgnoreToolMaterials': False, 'm_bIgnoreSky': False, 'm_bIgnoreNoDraw': False, 'm_bIgnoreTranslucent': False, 'm_bIgnoreModels': False, 'm_bIgnoreEntities': False, 'm_bIgnoreCables': False}},
    {'ComputeDotProduct3D': {'_WARN_NOT_VERIFIED': True, '_class': 'CSmartPropOperation_ComputeDotProduct3D', 'm_bEnabled': True, 'm_OutputVariableName': '', 'm_InputVectorA': None, 'm_InputVectorB': None}},
    {'ComputeCrossProduct3D': {'_WARN_NOT_VERIFIED': True, '_class': 'CSmartPropOperation_ComputeCrossProduct3D', 'm_bEnabled': True, 'm_OutputVariableName': '', 'm_InputVectorA': None, 'm_InputVectorB': None}},
    {'ComputeDistance3D': {'_WARN_NOT_VERIFIED': True, '_class': 'CSmartPropOperation_ComputeDistance3D', 'm_bEnabled': True, 'm_OutputVariableName': '', 'm_OutputCoordinateSpace': 'WORLD', 'm_InputPositionA': None, 'm_CoordinateSpaceA': 'WORLD', 'm_InputPositionB': None, 'm_CoordinateSpaceB': 'WORLD'}},
    {'ComputeProjectVector3D': {'_WARN_NOT_VERIFIED': True, '_class': 'CSmartPropOperation_ComputeProjectVector3D', 'm_bEnabled': True, 'm_OutputVariableName': '', 'm_OutputCoordinateSpace': 'WORLD', 'm_InputVectorA': None, 'm_CoordinateSpaceA': 'WORLD', 'm_InputVectorB': None, 'm_CoordinateSpaceB': 'WORLD', 'm_bPlane': False}},
    {'ComputeNormalizedVector3D': {'_WARN_NOT_VERIFIED': True, '_class': 'CSmartPropOperation_ComputeNormalizedVector3D', 'm_bEnabled': True, 'm_OutputVariableName': '', 'm_InputVector': None}},
    {'ComputeVectorBetweenPoints3D': {'_WARN_NOT_VERIFIED': True, '_class': 'CSmartPropOperation_ComputeVectorBetweenPoints3D', 'm_bEnabled': True, 'm_OutputVariableName': '', 'm_OutputCoordinateSpace': 'WORLD', 'm_bNormalized': False, 'm_InputPositionA': None, 'm_CoordinateSpaceA': 'WORLD', 'm_InputPositionB': None, 'm_CoordinateSpaceB': 'WORLD'}},
    {'TraceToPoint': {'_WARN_NOT_VERIFIED': True, '_class': 'CSmartPropOperation_TraceToPoint', 'm_Origin': None, 'm_OriginSpace': 'WORLD', 'm_flOriginOffset': 0.0, 'm_flSurfaceUpInfluence': 1.0, 'm_nNoHitResult': 'NOTHING', 'm_bIgnoreToolMaterials': False, 'm_bIgnoreSky': False, 'm_bIgnoreNoDraw': False, 'm_bIgnoreTranslucent': False, 'm_bIgnoreModels': False, 'm_bIgnoreEntities': False, 'm_bIgnoreCables': False, 'm_TargetPoint': None, 'm_TargetPointSpace': 'WORLD', 'm_bTraceAway': False, 'm_flTraceLength': 1000.0}},
    {'TraceToLine': {'_WARN_NOT_VERIFIED': True, '_class': 'CSmartPropOperation_TraceToLine', 'm_Origin': None, 'm_OriginSpace': 'WORLD', 'm_flOriginOffset': 0.0, 'm_flSurfaceUpInfluence': 1.0, 'm_nNoHitResult': 'NOTHING', 'm_bIgnoreToolMaterials': False, 'm_bIgnoreSky': False, 'm_bIgnoreNoDraw': False, 'm_bIgnoreTranslucent': False, 'm_bIgnoreModels': False, 'm_bIgnoreEntities': False, 'm_bIgnoreCables': False, 'm_EndPointA': None, 'm_EndPointSpaceA': 'WORLD', 'm_EndPointB': None, 'm_EndPointSpaceB': 'WORLD', 'm_bTraceAway': False, 'm_flTraceLength': 1000.0}},
