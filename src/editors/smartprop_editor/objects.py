...
elements_list = [
    ...
    {'PlaceOnPath': {
        ...
        'm_DefaultPath': [[-400.0, 0.0, 0.0], [-200.0, 32.0, 0.0], [200.0, -32.0, 0.0], [400.0, 0.0, 0.0]]
    }},
    {'FitOnLine': {
...
operators_list = [
    ...
    {'SetMaterialGroupChoice': {'_class': 'CSmartPropOperation_SetMateraialGroupChoice', 'm_VariableName': '', 'm_SelectionMode': 'RANDOM', 'm_ChoiceSelection': 0, 'm_MaterialGroupChoices': []}},
    ...
    {'ComputeDotProduct3D': {'_class': 'CSmartPropOperation_ComputeDotProduct3D', 'm_bEnabled': True, 'm_OutputVariableName': '', 'm_InputVectorA': None, 'm_InputVectorB': None}},
    {'ComputeCrossProduct3D': {'_class': 'CSmartPropOperation_ComputeCrossProduct3D', 'm_bEnabled': True, 'm_OutputVariableName': '', 'm_InputVectorA': None, 'm_InputVectorB': None}},
    {'ComputeDistance3D': {'_class': 'CSmartPropOperation_ComputeDistance3D', 'm_bEnabled': True, 'm_OutputVariableName': '', 'm_OutputCoordinateSpace': 'WORLD', 'm_InputPositionA': None, 'm_CoordinateSpaceA': 'WORLD', 'm_InputPositionB': None, 'm_CoordinateSpaceB': 'WORLD'}},
    {'ComputeProjectVector3D': {'_class': 'CSmartPropOperation_ComputeProjectVector3D', 'm_bEnabled': True, 'm_OutputVariableName': '', 'm_OutputCoordinateSpace': 'WORLD', 'm_InputVectorA': None, 'm_CoordinateSpaceA': 'WORLD', 'm_InputVectorB': None, 'm_CoordinateSpaceB': 'WORLD', 'm_bPlane': False}},
    {'ComputeNormalizedVector3D': {'_class': 'CSmartPropOperation_ComputeNormalizedVector3D', 'm_bEnabled': True, 'm_OutputVariableName': '', 'm_InputVector': None}},
    {'ComputeVectorBetweenPoints3D': {'_class': 'CSmartPropOperation_ComputeVectorBetweenPoints3D', 'm_bEnabled': True, 'm_OutputVariableName': '', 'm_OutputCoordinateSpace': 'WORLD', 'm_bNormalized': False, 'm_InputPositionA': None, 'm_CoordinateSpaceA': 'WORLD', 'm_InputPositionB': None, 'm_CoordinateSpaceB': 'WORLD'}},
