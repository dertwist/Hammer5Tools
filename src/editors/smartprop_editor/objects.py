...
elements_list = [
    ...
    {'PlaceInSphere': {
        ...
        'm_nCountMin': 0,
        'm_nCountMax': 0,
        'm_flPositionRadiusInner': 0,
        'm_flPositionRadiusOuter': 0,
    ...
    {'Model': {
        ...
        'm_nLodLevel': -1,
        'm_DetailObjectFadeLevel': 'MEDIUM',
        'm_nDeformableAttachmentMode': 'DEFAULT',
        'm_nDeformableOrientationMode': 'DEFAULT',
        'm_Modifiers': [],
        'm_SelectionCriteria': []
    }},
    {'ModelEntity': {
...
filters_list = [
    ...
    # {'VariableComparison [VariableValue]': {'_class': 'CSmartPropFilter_VariableValue', 'm_VariableComparison': {'m_Name': '', 'm_Value': 0, 'm_Comparison': 'EQUAL'}}}
