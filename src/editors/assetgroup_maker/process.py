...
from src.settings.main import get_cs2_path, get_addon_name, get_addon_dir, debug
...
from src.editors.assetgroup_maker.objects import load_hbat_file, get_default_file
