...
################################################################################
## Form generated from reading UI file 'popup_menu_tree.ui'
##
...
"}")
        ...
        self.treeWidget.header().setDefaultSectionSize(230)
    ...
    def retranslateUi(self, PoPupMenu):
        ...
        ___qtreewidgetitem.setText(1, QCoreApplication.translate("PoPupMenu", u"Value", None));
        ___qtreewidgetitem.setText(0, QCoreApplication.translate("PoPupMenu", u"Name", None));
    # retranslateUi
