...
from PySide6.QtWidgets import QMainWindow, QTreeView, QVBoxLayout, QStyledItemDelegate, QHeaderView, QMenu, QMessageBox, QFrame
...
class Explorer(QMainWindow):
    ...
    def __init__(self, parent=None, tree_directory=None, addon=None, editor_name=None, use_internal_player: bool = True):
        ...
        # Hide all columns except NAME_COLUMN and SIZE_COLUMN
        ...
        # Attempt to re-select the last opened path
    ...
    def add_file_actions(self, menu, index):
        ...
        # QuickConfigFile action for VMDL
        ...
        # QuickVmdlFile action for model files
    ...
    def delete_selected_items(self):
        ...
        paths = [
            ...
            if index.column() == CustomFileSystemModel.NAME_COLUMN
        ]
