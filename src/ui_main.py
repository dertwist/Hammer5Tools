...
"}")
        ...
        icon6 = QIcon()
        icon6.addFile(u":/social/icons/social/discord.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.discord.setIcon(icon6)
        ...
        icon7 = QIcon()
        icon7.addFile(u":/social/icons/social/twitter.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
