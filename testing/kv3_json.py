...
raw = """<!-- kv3 encoding:text:version{e21c7f3c-8a33-41c5-9977-a76d3a32aa0d} format:generic:version{7412167c-06e9-4698-aff2-e63eb59037e7} -->
{
	...
	[
			...
			m_sModelName = "models/de_overpass/overpass_bike_rack/bike_rack.vmdl"
			m_nElementID = 1
		},
				{
			_class = "CSmartPropElement_SmartProp"
			m_nElementID = 2
			m_sSmartProp = "smartprops/bicycle/bicycle_single.vsmart"
			m_Modifiers = 
			[
								{
					...
					m_vRandomRotationMin = [-5.0, 0.0, 0.0]
					m_vRandomRotationMax = [5.0, 0.0, 0.0]
				},
			]
		},
	]
...
"""
kv3_data = kv3.textreader.KV3TextReader().parse(raw)
print(kv3_data.value)
kv3_ouput = kv3.textwriter.encode(kv3_data)
print(kv3_ouput)