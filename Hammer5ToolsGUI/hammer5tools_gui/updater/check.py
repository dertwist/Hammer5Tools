...
try:
    ...
    velopack = None
    UpdateManager = None
from hammer5tools_gui.common import get_channel, get_update_source, get_update_options
from hammer5tools_gui.updater.attachment_preview import (
...
def prepare_for_update():
    ...
    # 1. Stop IPC server
    try:
        from hammer5tools_gui.ipc.server_utils import stop_ipc_server
        stop_ipc_server()
    except Exception as e:
