...
from hammer5tools_gui.widgets.model_browser.index import (
    ModelEntry, ScanWorker, ScanSignals, active_mounts, SOURCE_ADDON, SOURCE_CORE,
    GAME_MOUNTS, get_game_entries,
)
from hammer5tools_gui.widgets.model_browser.thumbnails import ThumbnailService, THUMB_SIZE
...
def save_saved_mod_selection(checked_mods: set, active_addon: Optional[str] = None) -> None:
    ...
    from hammer5tools_gui.settings.common import set_settings_value
    to_save = []
...
class ModelBrowserWidget(QWidget):
    ...
    def _start_scan(self, use_cache: bool = True):
        ...
        from hammer5tools_gui.widgets.model_browser.index import is_index_cached, scan_all
    ...
    def _load_game_entries(self):
        ...
        from hammer5tools_gui.settings.main import get_cs2_path
        from hammer5tools_gui.widgets.model_browser.index import get_game_entries
