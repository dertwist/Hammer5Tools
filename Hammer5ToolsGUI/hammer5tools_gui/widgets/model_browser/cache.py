...
def cache_root() -> str:
    from hammer5tools_gui.common import SmartPropEditor_Path
...
def clear_cache() -> Tuple[int, int, List[str]]:
    ...
    """
    try:
        from hammer5tools_gui.widgets.model_browser.index import invalidate_all_caches
        invalidate_all_caches()
    except Exception:
        pass

    try:
        from hammer5tools_gui.widgets.model_browser.main import clear_dialog_cache
        clear_dialog_cache()
    except Exception:
        pass
