...
from hammer5tools_gui.settings.main import get_settings_value, set_settings_value, get_cs2_path, get_addon_name, get_addon_dir, debug
from hammer5tools_gui.widgets.common import ErrorInfo
from hammer5tools_gui.widgets.explorer.actions import QuickVmdlFile, QuickConfigFile, QuickProcess, FixPBRRange, QuickVsmart
from hammer5tools_gui.widgets.tree import BranchTreeView
from hammer5tools_gui.styles.common import *
from hammer5tools_gui.common import enable_dark_title_bar
...
class ZebraMenu(QMenu):
    ...
    def paintEvent(self, event):
        ...
        from hammer5tools_gui.styles import theme
...
class Explorer(QMainWindow):
    ...
    def add_folder_actions(self, menu, index):
        ...
        from hammer5tools_gui.common import compile as run_compile
    ...
    def convert_audio_file(self, file_path, target_ext):
        ...
        from hammer5tools_gui.editors.soundevent_editor.audio_convert import convert_audio
    ...
    def duplicate_file(self, index):
        ...
        if QFile.copy(file_path, new_file_path):
            if new_file_path.lower().endswith('.hbat'):
                from hammer5tools_gui.editors.assetgroup_maker.monitor import MonitoringFileWatcher
    ...
    def open_asset_manager(self, index):
        ...
        from hammer5tools_gui.forms.asset_manager.main import AssetManagerWidget
    ...
    def open_asset_exporter(self, index):
        ...
        from hammer5tools_gui.forms.asset_exporter.main import AssetExporterWidget
    ...
    def open_asset_renamer(self, index):
        ...
        if ok and new_name and new_name != old_name:
            ...
            from hammer5tools_gui.forms.asset_manager.move_worker import MoveWorker
