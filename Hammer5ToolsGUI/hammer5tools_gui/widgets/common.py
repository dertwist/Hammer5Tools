...
from hammer5tools_gui.common import discord_feedback_channel
...
class ErrorInfo(QDialog):
    ...
    def dont_show_again(self):
        if self.dont_show_setting:
            from hammer5tools_gui.settings.common import set_settings_bool
...
if __name__ == "__main__":
    ...
    from PySide6.QtGui import QIcon
    from hammer5tools_gui.widgets.common import Button, DeleteButton, CheckBox
