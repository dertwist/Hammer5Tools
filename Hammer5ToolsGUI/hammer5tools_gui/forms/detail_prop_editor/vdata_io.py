...
from hammer5tools_gui.common import Kv3ToJson, JsonToKv3
from hammer5tools_gui.settings.common import get_addon_dir
...
def save_vdata(path: str, types: dict):
    ...
    from hammer5tools_gui.common import editor_info, fast_deepcopy
    payload = {
