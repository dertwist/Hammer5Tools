...
from hammer5tools_gui.styles.common import qt_stylesheet_combobox, qt_stylesheet_checkbox, qt_stylesheet_button, qt_stylesheet_table

from hammer5tools_gui.settings.main import get_addon_name, get_addon_dir, get_cs2_path
from hammer5tools_gui.widgets import qt_stylesheet_button, enable_dark_title_bar
from hammer5tools_gui.forms.cleanup.common import format_size
from hammer5tools_gui.forms.cleanup.parse import get_junk_files
...
class CleanupDialog(QDialog):
    ...
    def run_verification(self):
        ...
        try:
            from hammer5tools_gui.forms.cleanup.parse import get_vmap_references
