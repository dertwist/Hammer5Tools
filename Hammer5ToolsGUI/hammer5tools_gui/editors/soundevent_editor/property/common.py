...
from hammer5tools_gui.settings.main import get_addon_dir
from hammer5tools_gui.common import convert_snake_case
try:
    from hammer5tools_gui.editors.soundevent_editor.property.curve.ui_main import Ui_CurveWidget
except:
    pass
from hammer5tools_gui.widgets import FloatWidget, LegacyWidget, BoolWidget, DeleteButton, Button, ComboboxDynamicItems, Spacer
