...
from hammer5tools_gui.widgets import BoxSlider
from hammer5tools_gui.editors.soundevent_editor.property.curve.algorithm import (CurvePoint, setup_all_curve_values, sample_curve)
from hammer5tools_gui.widgets.common import DeleteButton, Button
