from hammer5tools_gui.property.methods import QDrag
import os
import time
...
from hammer5tools_gui.settings.main import get_cs2_path, get_addon_dir, debug
from hammer5tools_gui.common import SoundEventEditor_path
