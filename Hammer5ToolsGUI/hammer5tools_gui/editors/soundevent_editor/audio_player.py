...
from hammer5tools_gui.settings.main import set_settings_bool, get_settings_bool
from hammer5tools_gui.editors.soundevent_editor.ui_audio_player import Ui_Form
