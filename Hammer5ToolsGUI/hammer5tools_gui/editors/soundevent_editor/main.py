...
from hammer5tools_gui.settings.main import get_addon_name, get_cs2_path, debug, get_settings_bool, get_settings_value, settings, get_addon_dir
from hammer5tools_gui.editors.soundevent_editor.ui_main import Ui_MainWindow
...
from hammer5tools_gui.widgets import HierarchyItemModel, ErrorInfo
from hammer5tools_gui.editors.soundevent_editor.commands import *
from hammer5tools_gui.widgets.commands import AddItemCommand, PasteItemsCommand, MoveItemsCommand
from hammer5tools_gui.editors.soundevent_editor.properties_window import SoundEventEditorPropertiesWindow
from hammer5tools_gui.editors.soundevent_editor.property_browser import PropertyBrowserWidget
from PySide6.QtWidgets import QInputDialog, QHBoxLayout, QPushButton
from hammer5tools_gui.common import *
from hammer5tools_gui.editors.soundevent_editor.internal_explorer import InternalSoundFileExplorer
from hammer5tools_gui.editors.soundevent_editor.internal_soundevent_explorer import InternalSoundEventExplorer
from hammer5tools_gui.editors.soundevent_editor.soundevent_player import play_soundevent
from hammer5tools_gui.editors.soundevent_editor.audio_player import AudioPlayer
from hammer5tools_gui.widgets.common import exception_handler
...
class SoundEventEditorMainWindow(QMainWindow):
    def __init__(self, parent=None, update_title=None):
        ...
        from hammer5tools_gui.editors.soundevent_editor.soundevent_player import SoundEventPlayerWidget
    ...
    def save_current_soundevent_as_template(self):
        ...
        from hammer5tools_gui.common import SoundEventEditor_Preset_Path, JsonToKv3
    ...
    def filter_editor_properties(self, text: str):
        ...
        for index in range(layout.count()):
            ...
            if not item:
                continue
            widget = item.widget()
            from hammer5tools_gui.editors.soundevent_editor.property.frame import SoundEventEditorPropertyFrame
