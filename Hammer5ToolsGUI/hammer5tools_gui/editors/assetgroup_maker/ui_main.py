...
class Ui_BatchCreator_MainWindow(object):
    def setupUi(self, BatchCreator_MainWindow):
        ...
        BatchCreator_MainWindow.setStyleSheet(u"background-color: #2e2e2e;")
        ...
        self.kv3_QplainTextEdit.setMinimumSize(QSize(0, 256))
...
"}")
    ...
    def retranslateUi(self, BatchCreator_MainWindow):
        ...
        self.dockWidget_2.setWindowTitle(QCoreApplication.translate("BatchCreator_MainWindow", u"Config browser", None))
