...
################################################################################
## Form generated from reading UI file 'frame_group.ui'
##
...
import hammer5tools_gui.resources_rc as resources_rc
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        Form.setStyleSheet(u"background-color: #2e2e2e;")
...
#endif // QT_CONFIG(tooltip)
        self.property_class.setText(QCoreApplication.translate("Form", u"Replacements", None))
