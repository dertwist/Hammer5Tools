...
from hammer5tools_gui.settings.main import get_cs2_path, get_addon_name, get_addon_dir, debug
from hammer5tools_gui.editors.assetgroup_maker.matcher import match_folder_assets, AssetGroupItem
from hammer5tools_gui.editors.assetgroup_maker.analyzer import (
    analyze_reference_file, resolve_reference_full_path, get_addon_root_from_path
)
from hammer5tools_gui.editors.assetgroup_maker.objects import load_hbat_file, get_default_file
...
def render_asset_template(
    ...
    if material_remaps:
        ...
        if mesh_full and mesh_full.lower().endswith('.fbx') and os.path.isfile(mesh_full):
            from hammer5tools_gui.editors.assetgroup_maker.analyzer import extract_fbx_materials
