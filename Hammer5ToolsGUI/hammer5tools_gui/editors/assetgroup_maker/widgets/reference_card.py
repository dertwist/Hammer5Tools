...
from hammer5tools_gui.editors.assetgroup_maker.analyzer import analyze_reference_file, ReferenceAnalysisResult
...
class TemplateCardWidget(QWidget):
    ...
    def _on_asset_browser_clicked(self):
        ...
        from hammer5tools_gui.settings.main import get_addon_name
        result = pick_asset(
            self,
