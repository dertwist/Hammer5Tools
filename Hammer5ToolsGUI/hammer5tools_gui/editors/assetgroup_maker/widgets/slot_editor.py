...
from hammer5tools_gui.settings.main import get_addon_dir, get_addon_name, debug
...
from hammer5tools_gui.editors.assetgroup_maker.matcher import (
...
class TemplateSlotMappingDialog(QDialog):
    ...
    def _on_browse_vmat(self, target_edit: QLineEdit):
        from hammer5tools_gui.widgets.model_browser import pick_asset
        result = pick_asset(
            self,
