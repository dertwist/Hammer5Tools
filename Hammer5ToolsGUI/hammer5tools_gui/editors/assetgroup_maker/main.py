...
from hammer5tools_gui.settings.main import get_addon_name, get_cs2_path, get_addon_dir, get_settings_value, set_settings_value, debug
...
from hammer5tools_gui.editors.assetgroup_maker.objects import get_default_file
from hammer5tools_gui.styles.common import qt_stylesheet_button, qt_stylesheet_checkbox, qt_stylesheet_lineedit
...
class BatchCreatorMainWindow(QMainWindow):
    ...
    def _build_ui(self):
        ...
        from hammer5tools_gui.widgets.document_tab import DocumentTabWidget
