...
from hammer5tools_gui.settings.common import get_addon_dir, get_cs2_path
from hammer5tools_gui.settings.main import get_settings_value, get_settings_bool

from keyvalues3 import kv3_to_json
from hammer5tools_gui.editors.smartprop_editor.ui_document import Ui_MainWindow
from hammer5tools_gui.settings.main import settings
from hammer5tools_gui.editors.smartprop_editor.objects import (
    variables_list,
    variable_prefix,
    elements_list,
    operators_list,
...
from hammer5tools_gui.editors.smartprop_editor.vsmart import (
...
from hammer5tools_gui.editors.smartprop_editor.props.panel import SmartPropPropertyPanel
from hammer5tools_gui.editors.smartprop_editor.choices import AddChoice, AddVariable, AddOption
from hammer5tools_gui.widgets.popup_menu.main import PopupMenu
from hammer5tools_gui.editors.smartprop_editor.commands import (
...
from hammer5tools_gui.forms.replace_dialog.main import FindAndReplaceDialog
from hammer5tools_gui.widgets import ErrorInfo, on_three_hierarchyitem_clicked, HierarchyItemModel, error, exception_handler
from hammer5tools_gui.widgets.element_id import ElementIDGenerator
from hammer5tools_gui.editors.smartprop_editor._common import (
...
from hammer5tools_gui.widgets.tree import HierarchyTreeWidget
from hammer5tools_gui.editors.smartprop_editor.variables_viewport import SmartPropEditorVariableViewport
from hammer5tools_gui.editors.smartprop_editor.manual_editor import ManualEditor
...
class SmartPropDocument(QMainWindow):
    ...
    def add_preset(self):
        from hammer5tools_gui.common import get_all_presets, SmartPropEditor_Internal_Preset_Path, SmartPropEditor_User_Preset_Path
    ...
    def load_preset(self, name: str = None, path: str = None):
        ...
        if items or new_variables != old_variables or new_choices != old_choices:
            from hammer5tools_gui.editors.smartprop_editor.commands import NewFromPresetCommand
    ...
    def open_bulk_model_importer(self):
        from hammer5tools_gui.editors.smartprop_editor.actions.bulk_model_importer import BulkModelImporterDialog
        from hammer5tools_gui.editors.smartprop_editor._common import get_clean_class_name_value, get_label_id_from_value
    ...
    def load_vmap_into_hierarchy(self):
        ...
        from hammer5tools_gui.editors.smartprop_editor.vsmart import deserialize_hierarchy_item
        import os
    ...
    def _on_hierarchy_item_changed(self, item, column):
        ...
        if (
            ...
            if new_label != self._hierarchy_rename_old_label:
                from hammer5tools_gui.editors.smartprop_editor.commands import HierarchyItemRenameCommand
                self.undo_stack.push(
