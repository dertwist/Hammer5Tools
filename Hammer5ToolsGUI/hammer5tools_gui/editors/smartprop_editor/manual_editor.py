...
from hammer5tools_gui.common import JsonToKv3, fast_deepcopy
...
class _SearchReplaceBar(QFrame):
    ...
    def __init__(self, editor: Kv3CodeEditor, parent=None):
        ...
        self._editor = editor
        self._last_search = ""
        from hammer5tools_gui.styles.common import qt_stylesheet_button, qt_stylesheet_lineedit
        ...
        from hammer5tools_gui.styles.common import qt_stylesheet_checkbox
...
class ManualEditor(QWidget):
    ...
    def _serialise_hierarchy(self) -> str:
        ...
        from hammer5tools_gui.editors.smartprop_editor.vsmart import serialization_hierarchy_items
    ...
    def _serialise_variables(self) -> str:
        ...
        for i in range(layout.count()):
            ...
            if widget and hasattr(widget, 'name') and hasattr(widget, 'var_class'):
                from hammer5tools_gui.editors.smartprop_editor.objects import variable_prefix
    ...
    def _serialise_choices(self) -> str:
        ...
        from hammer5tools_gui.widgets.element_id import set_ElementID
        choices = []
        for ch in state:
            options = []
    ...
    def _apply_variables(self, text):
        ...
        from hammer5tools_gui.editors.smartprop_editor.commands import VariablesSnapshotCommand
    ...
    def _apply_choices(self, text):
        ...
        from hammer5tools_gui.editors.smartprop_editor.commands import ChoicesSnapshotCommand
