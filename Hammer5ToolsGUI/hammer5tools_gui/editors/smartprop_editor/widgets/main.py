...
from hammer5tools_gui.widgets.common import Button, apply_stylesheets
from hammer5tools_gui.widgets import ComboboxDynamicItems
...
class ComboboxVariablesWidget(QWidget):
    ...
    def add_variable(self, name, var_class, var_value, var_visible_in_editor, var_display_name, index: int = None):
        ...
        from hammer5tools_gui.editors.smartprop_editor.variable_frame import VariableFrame
