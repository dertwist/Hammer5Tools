...
from hammer5tools_gui.editors.smartprop_editor.objects import expression_completer
from hammer5tools_gui.editors.smartprop_editor._common import is_category_widget, is_category_variable_name
