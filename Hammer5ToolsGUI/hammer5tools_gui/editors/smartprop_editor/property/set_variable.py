from hammer5tools_gui.editors.smartprop_editor.property.ui_set_variable import Ui_Widget
...
from hammer5tools_gui.widgets import FloatWidget, BoolWidget
...
class PropertyVariableValue(QWidget):
    ...
    def __init__(self, value_class, value, variables_scrollArea, element_id_generator, **kwargs):
        super().__init__()
        try:
            self.ui = Ui_Widget()
