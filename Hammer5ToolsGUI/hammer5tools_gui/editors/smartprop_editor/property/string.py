import re
from hammer5tools_gui.editors.smartprop_editor.property.ui_float import Ui_Widget
...
from hammer5tools_gui.widgets import Spacer
...
from hammer5tools_gui.editors.smartprop_editor.property.base_pooled import PooledPropertyMixin
...
class PropertyString(QWidget, PooledPropertyMixin):
    ...
    def _open_browser(self):
        if self._browser_type == 'smartprop':
            from hammer5tools_gui.widgets.model_browser import pick_smartprop
            path = pick_smartprop(self, current_path=self.text_line.toPlainText().strip())
        else:
            from hammer5tools_gui.widgets.model_browser import pick_model
