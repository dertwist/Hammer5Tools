import ast
import re
from hammer5tools_gui.editors.smartprop_editor.property.ui_combobox import Ui_Widget
...
class PropertyCombobox(QWidget, PooledPropertyMixin):
    edited = Signal()
    def __init__(self, value_class, value, variables_scrollArea, items, filter_types, element_id_generator, parent=None):
        ...
        compact.style_value_combobox(self.ui.value)
