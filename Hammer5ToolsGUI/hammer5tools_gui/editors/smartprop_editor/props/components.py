...
from hammer5tools_gui.editors.smartprop_editor._common import get_clean_class_name
from hammer5tools_gui.editors.smartprop_editor.commands import PropertySnapshotCommand
from hammer5tools_gui.widgets.widgets import make_composite_icon
from hammer5tools_gui.editors.smartprop_editor.objects import (
    filters_list,
    operators_list,
    selection_criteria_list,
)
from hammer5tools_gui.editors.smartprop_editor.properties_group_frame import PropertiesGroupFrame
    ...
    def update_data(self, data: dict):
        ...
        if eid is None:
            ...
            if doc and hasattr(doc, "element_id_generator"):
                ...
                from hammer5tools_gui.widgets.element_id import get_ElementID
