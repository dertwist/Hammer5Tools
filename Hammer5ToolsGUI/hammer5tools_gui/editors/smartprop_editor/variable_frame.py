from hammer5tools_gui.common import JsonToKv3
from hammer5tools_gui.editors.smartprop_editor.ui_variable_frame import Ui_Form
from PySide6.QtWidgets import QWidget, QMenu, QApplication, QHBoxLayout, QLabel, QFrame
from PySide6.QtCore import Qt, Signal, QEvent, QSize
from PySide6.QtGui import QCursor, QAction
from hammer5tools_gui.property.methods import PropertyMethods
from hammer5tools_gui.widgets.element_id import *
from hammer5tools_gui.settings.main import get_settings_bool
from hammer5tools_gui.widgets.popup_menu.main import PopupMenu
from hammer5tools_gui.editors.smartprop_editor.objects import variables_list
...
from hammer5tools_gui.editors.smartprop_editor.widgets.expression_editor.main import ExpressionEditor
...
class VariableFrame(PropertyMethods, QWidget):
    ...
    def _initialize_var_instance(self, var_class):
        if var_class == 'Int':
            from hammer5tools_gui.editors.smartprop_editor.variables.int import Var_class_Int
            ...
            from hammer5tools_gui.editors.smartprop_editor.variables.float import Var_class_float
            self.var_int_instance = Var_class_float(
                default=self.var_default, min=self.var_min, max=self.var_max, model=None
            )
        elif var_class == 'MaterialGroup':
            from hammer5tools_gui.editors.smartprop_editor.variables.material_group import Var_class_material_group
            ...
            from hammer5tools_gui.editors.smartprop_editor.variables.model import Var_class_model
            self.var_int_instance = Var_class_model(
                default=self.var_default, min=self.var_min, max=self.var_max, model=self.var_model
            )
        elif var_class == 'Material':
            from hammer5tools_gui.editors.smartprop_editor.variables.material import Var_class_material
            self.var_int_instance = Var_class_material(
                default=self.var_default, min=self.var_min, max=self.var_max, model=self.var_model
            )
        elif var_class == 'Bool':
            from hammer5tools_gui.editors.smartprop_editor.variables.bool import Var_class_bool
            self.var_int_instance = Var_class_bool(
                default=self.var_default, min=self.var_min, max=self.var_max, model=self.var_model
            )
        elif var_class == 'Color':
            from hammer5tools_gui.editors.smartprop_editor.variables.color import Var_class_color
            ...
            from hammer5tools_gui.editors.smartprop_editor.variables.combobox import Var_class_combobox
            ...
            from hammer5tools_gui.editors.smartprop_editor.variables.vector2d import Var_class_vector2d
            self.var_int_instance = Var_class_vector2d(default=self.var_default)
        elif var_class == 'Vector3D':
            from hammer5tools_gui.editors.smartprop_editor.variables.vector3d import Var_class_vector3d
            self.var_int_instance = Var_class_vector3d(default=self.var_default)
        elif var_class == 'Vector4D':
            from hammer5tools_gui.editors.smartprop_editor.variables.vector4d import Var_class_vector4d
            self.var_int_instance = Var_class_vector4d(default=self.var_default)
        else:
            from hammer5tools_gui.editors.smartprop_editor.variables.legacy import Var_class_legacy
