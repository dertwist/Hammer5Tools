...
from hammer5tools_gui.editors.smartprop_editor.viewport_3d.render_area import link_program, safe_normal_matrix
...
class PathEditor3DRenderArea(QOpenGLWidget):
    ...
    def __init__(self, points=None, parent=None):
        ...
        from hammer5tools_gui.editors.smartprop_editor.viewport_3d.gl_settings import (
    ...
    def paintGL(self):
        ...
        if self._perform_pick_flag:
            ...
            from hammer5tools_gui.styles import theme as _theme
