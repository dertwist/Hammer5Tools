...
from hammer5tools_gui.settings.common import *
from hammer5tools_gui.common import enable_dark_title_bar, Presets_Path, app_dir, get_channel, get_build_channel
from hammer5tools_gui.widgets.common import Button  # Using the internal Button class
from hammer5tools_gui.styles.common import qt_stylesheet_checkbox, qt_stylesheet_combobox
from hammer5tools_gui.other.file_association import setup_all_associations
...
class PreferencesDialog(QDialog):
    ...
    def cleanup_model_browser_cache(self):
        ...
        """
        from PySide6.QtWidgets import QMessageBox
        from hammer5tools_gui.widgets.model_browser.cache import cache_size, clear_cache, human_size
