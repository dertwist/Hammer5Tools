...
def format_crash_report(exc_type, exc, tb, thread_name=None):
    ...
    try:
        from hammer5tools_gui.common import app_version
    except Exception:
        app_version = 'unknown'
...
if __name__ == "__main__":
    ...
    from hammer5tools_gui.no_console import install as _install_no_console
    _install_no_console()
    ...
    from hammer5tools_gui.app_core import Widget, start_instance_server, QT_Stylesheet_global, check_dotnet_runtime
    from PySide6.QtWidgets import QApplication
