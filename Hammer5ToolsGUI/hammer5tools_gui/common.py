...
from hammer5tools_gui.other.get_cs2_path import get_counter_strike_path_from_registry, get_steam_install_path
from hammer5tools_gui.styles.common import qt_stylesheet_tabbar
import sys
import os
import subprocess
...
def get_channel() -> str:
    ...
    """
    try:
        from hammer5tools_gui.settings.common import get_settings_bool
...
def compile(input_file, fshallow=False, fshallow2=False, force=False, verbose=False):
    ...
    def run_rc(input_file):
        from hammer5tools_gui.settings.common import get_cs2_path
...
def get_cs2_path():
    from hammer5tools_gui.settings.common import get_cs2_path as _get_cs2_path
