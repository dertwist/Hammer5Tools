...
from hammer5tools_gui.forms.about.main import AboutDialog
from hammer5tools_gui.forms.mapbuilder.main import MapBuilderDialog
from hammer5tools_gui.git_sync.controller import GitController, SyncButton
from hammer5tools_gui.settings.main import (
    PreferencesDialog,
    get_steam_path,
    get_cs2_path,
    get_addon_name,
...
from hammer5tools_gui.editors.loading_editor.main import Loading_editorMainWindow
from hammer5tools_gui.editors.hotkey_editor.main import HotkeyEditorMainWindow
from hammer5tools_gui.forms.create_addon.main import Create_addon_Dialog
from hammer5tools_gui.other.addon_functions import delete_addon, launch_addon
from hammer5tools_gui.other.file_association import check_association, setup_all_associations
from hammer5tools_gui.updater.check import check_updates
from hammer5tools_gui.forms.export.main import ExportAndImportAddonDialog
from hammer5tools_gui.editors.assetgroup_maker.main import BatchCreatorMainWindow
from hammer5tools_gui.editors.smartprop_editor.main import SmartPropEditorMainWindow
from hammer5tools_gui.editors.soundevent_editor.main import SoundEventEditorMainWindow
from hammer5tools_gui.forms.unreal_porter.main import UnrealPorterWidget
from hammer5tools_gui.forms.source_porter.main import SourcePorterWidget
from hammer5tools_gui.forms.launch_options.main import LaunchOptionsDialog
from hammer5tools_gui.common import app_version, default_commands, JsonToKv3, compile as run_compile
from hammer5tools_gui.styles.qt_global_stylesheet import QT_Stylesheet_global
from hammer5tools_core.dotnet import check_dotnet_runtime
from hammer5tools_gui.other.addon_validation import validate_addon_structure
from hammer5tools_gui.forms.cleanup.main import CleanupDialog
from hammer5tools_gui.forms.quick_create.main import QuickCreateDialog
from hammer5tools_gui.widgets import *
...
class Widget(QMainWindow):
    def __init__(self, parent=None, dev_mode=False):
        super().__init__(parent)
        from hammer5tools_gui.ui_main import Ui_MainWindow
    ...
    def handle_quick_vmdl(self, path):
        if os.path.isfile(path):
            ...
            from hammer5tools_gui.editors.assetgroup_maker.objects import DEFAULT_VMDL
            from hammer5tools_gui.common import fast_deepcopy
    ...
    def setup_tabs(self):
        ...
        from hammer5tools_gui.editors.soundevent_editor.wave_editor import AudioEditor
    ...
    def selected_addon_name(self, text=None):
        ...
        if cs2_path is not None:
            ...
            if hasattr(self, 'detailpropeditor_tab'):
                from hammer5tools_gui.forms.detail_prop_editor.main import DetailPropEditorWidget
...
def start_instance_server(widget):
    from hammer5tools_gui.ipc.server_utils import set_ipc_server
    server = QLocalServer()
