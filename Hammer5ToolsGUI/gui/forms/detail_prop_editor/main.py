...
from gui.editors.smartprop_editor.viewport_3d.vmdl_reader import get_model_material_groups
...
class DetailPropEditorWidget(QMainWindow):
    ...
    def _build_property_panel(self) -> QWidget:
        ...
        self.property_host.setProperty("h5Component", "detailPropertyHost")
    ...
    def _render_type(self, item, data):
        ...
        summary.setProperty("h5Component", "detailPropSummaryLabel")
