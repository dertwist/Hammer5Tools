...
class Explorer(QMainWindow):
    ...
    def add_folder_actions(self, menu, index):
        ...
        from gui.common import compile as run_compile
    ...
    def convert_audio_file(self, file_path, target_ext):
        ...
        from gui.editors.soundevent_editor.audio_convert import convert_audio
    ...
    def open_asset_manager(self, index):
        ...
        from gui.forms.asset_manager.main import AssetManagerWidget
    ...
    def open_asset_exporter(self, index):
        ...
        from gui.forms.asset_exporter.main import AssetExporterWidget
