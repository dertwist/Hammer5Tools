...
from gui.editors.smartprop_editor.ui_variable_frame import Ui_Form
...
class VariableFrame(PropertyDragDropMixin, QWidget):
    ...
    def __init__(self, name, var_class, var_value, var_visible_in_editor, var_display_name, widget_list,
        ...
        self.ui.frame_3.setProperty("h5Component", "smartpropDisplayNameFrame")
        self.ui.label_2.setProperty("h5Component", "smartpropDisplayNameLabel")
        self.ui.varialbe_display_name.setProperty("h5Component", "smartpropDisplayNameInput")
