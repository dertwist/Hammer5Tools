from gui.editors.smartprop_editor.variables.ui_vector2d import Ui_Widget

from PySide6.QtWidgets import QWidget
from PySide6.QtCore import Signal
from gui.editors.smartprop_editor.property import compact

class Vector2DVariable(QWidget):
    edited = Signal(list, str, str, str)
    def __init__(self, default):
        super().__init__()
        self.ui = Ui_Widget()
        self.ui.setupUi(self)
        compact.style_variable_body(self, ("axisX", "axisY"))
...
Var_class_vector2d = Vector2DVariable
