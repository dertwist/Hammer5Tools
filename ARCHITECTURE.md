...
- **`CoreBridge.read_valve_map()`**: Loads the SourcePorter implementation of the shared VMAP reader and returns Python-native entities, asset references, and preview thumbnails. Loading Screen, Cleanup, and Create Addon consume this API instead of loading KeyValues2 or traversing Datamodel objects directly.
