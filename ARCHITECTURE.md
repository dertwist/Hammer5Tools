...
- **`CoreBridge.read_valve_map()`**: Loads the SourcePorter implementation of the shared VMAP reader and returns Python-native entity and asset-reference projections. Loading Screen camera extraction and Cleanup dependency discovery consume this API instead of loading KeyValues2 or traversing Datamodel objects directly.
