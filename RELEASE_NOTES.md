...
* Cleanup Addon: Upgraded the `.vsmart` smartprop parser to be suffix-generic (scanning `m_sSmartProp`, `m_sModelName`, `m_DefaultValue`, etc.) and fixed nested recursive smartprop path resolution.