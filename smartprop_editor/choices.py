...
class VariableFloat(VariableWidget):
    def __init__(self, value=0.0, type=None):
        super().__init__()
        self.data = {'m_Value': value, 'm_DataType': type}
        self.setupUI()
    def setupUI(self):
        ...
        self.slider.setValue(int(self.data['m_Value'] * 100))
