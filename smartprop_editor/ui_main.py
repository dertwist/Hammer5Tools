...
"    }")
        ...
        self.dockWidget_4.setFeatures(QDockWidget.DockWidgetFloatable|QDockWidget.DockWidgetMovable)
        ...
        self.dockWidget_10.setFeatures(QDockWidget.DockWidgetFloatable|QDockWidget.DockWidgetMovable)
