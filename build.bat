...
pyinstaller --name="Hammer5Tools" --noconfirm --onefile --windowed --optimize "2" --icon appicon.ico --add-data "appicon.ico:." --add-data "images;images/" --add-data "qt_styles;qt_styles/" --noupx --distpath hammer5tools main.py
