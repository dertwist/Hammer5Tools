...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.cerate_file_button_4 = QPushButton(self.centralwidget)
...
"    }")
        ...
        self.cerate_file_button_3.setIcon(icon1)
...
"}")
        ...
        self.presets_list = QListWidget(self.dockWidgetContents)
        ...
        self.open_file_as_button_2 = QPushButton(self.dockWidgetContents)
...
"    }")
        icon3 = QIcon()
        icon3.addFile(u":/icons/add_24dp_9D9D9D_FILL0_wght400_GRAD0_opsz24.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.cerate_file_button.setIcon(icon3)
...
#endif // QT_CONFIG(shortcut)
        self.dockWidget.setWindowTitle(QCoreApplication.translate("MainWindow", u"Keybindings presets", None))
