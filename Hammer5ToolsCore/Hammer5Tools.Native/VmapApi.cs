...
/// <summary>NativeAOT ABI for the SourcePorter.Core VMAP read/rewrite/write contract.</summary>
internal static unsafe class VmapApi
{
    ...
    // is generated into SourcePorter.Core's own global namespace by the KeyValues2
    // package's analyzer; it exists even though nothing there subclasses Datamodel.Element.
