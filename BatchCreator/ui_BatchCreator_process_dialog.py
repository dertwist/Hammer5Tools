...
################################################################################
## Form generated from reading UI file 'BatchCreator_process_dialog.ui'
##
...
class Ui_BatchCreator_process_Dialog(object):
    def setupUi(self, BatchCreator_process_Dialog):
        ...
        self.select_files_to_process_button.setStyleSheet(u"\n"
...
"    }")
        ...
        self.load_from_the_folder_checkBox.setFocusPolicy(Qt.NoFocus)
...
"")
        ...
        self.choose_output_button.setStyleSheet(u"\n"
"    /* QPushButton default and hover styles */\n"
"    QPushButton {\n"
"\n"
"        font: 600 10pt \"Segoe UI\";\n"
...
"/* -------------------------- */")
        ...
        self.process_button.setStyleSheet(u"\n"
"    /* QPushButton default and hover styles */\n"
"    QPushButton {\n"
"\n"
"        font: 600 10pt \"Segoe UI\";\n"
