...
"}")
        ...
        self.scrollAreaWidgetContents.setGeometry(QRect(0, 0, 964, 584))
...
"}")
        ...
        self.properties_spacer.setFrameShape(QFrame.StyledPanel)
        self.properties_spacer.setFrameShadow(QFrame.Raised)
        ...
        self.hierarchy_widget.setDragDropMode(QAbstractItemView.InternalMove)
        self.hierarchy_widget.setDefaultDropAction(Qt.MoveAction)
        self.hierarchy_widget.setAlternatingRowColors(True)
        self.hierarchy_widget.setSelectionMode(QAbstractItemView.ExtendedSelection)
        ...
        self.hierarchy_widget.header().setMinimumSectionSize(100)
