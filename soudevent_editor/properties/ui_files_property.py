...
################################################################################
## Form generated from reading UI file 'files_property.ui'
##
...
"")
    ...
    def retranslateUi(self, PropertyWidet):
        ...
        self.pushButton.setText(QCoreApplication.translate("PropertyWidet", u"Add selected file from explorer", None))
    # retranslateUi
