...
class Ui_Widget(object):
    def setupUi(self, Widget):
        ...
        self.archive_addon_button = QToolButton(Widget)
        self.archive_addon_button.setObjectName(u"archive_addon_button")
        font1 = QFont()
        font1.setPointSize(11)
        self.archive_addon_button.setFont(font1)
        icon4 = QIcon()
        icon4.addFile(u":/icons/archive_16dp_666666_FILL0_wght400_GRAD0_opsz20.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.archive_addon_button.setIcon(icon4)
        self.archive_addon_button.setIconSize(QSize(20, 20))

        self.horizontalLayout_2.addWidget(self.archive_addon_button)
...
#if QT_CONFIG(tooltip)
        self.archive_addon_button.setToolTip(QCoreApplication.translate("Widget", u"<html><head/><body><p><span style=\" font-size:12pt; font-weight:700;\">Archive addon</span></p><p>Create an archive on from game and content folders.</p></body></html>", None))
#endif // QT_CONFIG(tooltip)
        self.archive_addon_button.setText(QCoreApplication.translate("Widget", u"...", None))
#if QT_CONFIG(tooltip)
