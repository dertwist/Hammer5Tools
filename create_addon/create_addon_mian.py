...
import shutil, os, re
from preferences import get_cs2_path, get_config_value, set_config_value, set_addon_name
from create_addon.ui_create_addon_dialog import Ui_Create_addon_Dialog
